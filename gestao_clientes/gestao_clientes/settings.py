...
SECRET_KEY = 'jl$&42%jv5b^v4bo1_!hl-r8d50f42+kp!8+pj)nem+v#&p%^4'
...
#determina a url para o login
LOGIN_URL = '/login/'

#determina para onde será feito o redirecionamento quando o usuário fizer o login
